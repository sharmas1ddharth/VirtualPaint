...
myColors = [[25, 143, 76, 179, 255, 255],
            [113,158, 33, 132, 248, 255],
            [133, 56, 0, 159, 156, 255],
            [57, 76, 0, 100, 255, 255]]

myColorsValues = [[0, 255, 255],  ## BGR formatq
                  [255, 0, 0],
                  [255, 0, 255],
                  [0, 255, 0]]
...
def findColour(img, myColors, myColorsValues):
...
while True:
    ...
    newPoints = findColour(frame, myColors, myColorsValues)
    if len(newPoints) != 0:
    ...
    cv2.imshow("video", cv2.flip(imgResult, 1))
